...
#define SCAN_SIGNAL_THRESH 20000  /* out of 65535 (~30%) */
...
typedef struct {
    ...
    int           scan_started;  /* thread was created, needs pthread_join */
...
int      radio_seek(Radio *r, int fwd); /* 1=fwd 0=back; -1 on error */
